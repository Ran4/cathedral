Status: In progress (2026-09-08). M2a1–M2a6 private components are implemented and reviewed; the complete M2a envelope and remaining owners, M2b capture/hydration, M2c pending-work restoration and M2d continuation remain pending.
