Status: In progress (2026-09-08). M2a1–M2a5 private components are implemented and reviewed; the complete M2a envelope and remaining owners, M2b capture/hydration, M2c pending-work restoration and M2d continuation remain pending.
...
[Admission](evidence/m2a5/ADMISSION.md) retains lexical raw-input charges plus a combined 4,456,448 B allowance for sequential geography, adjacency and home-definition work. The active probe fills six stored holdings per actual actor and keeps historical receipts, seated occasions and publication caches; it makes no complete-save or synchronous-frame claim. Continuation uses a deliberately scrambled covered component in an independently prepared Engine, with immediate canonical equality before subsequent ordinary polls. Final focused/public and full workspace verification pass (1,949 tests); [verification](evidence/m2a5/verification.json) binds exact raw evidence to the final source. [Coordinator review](evidence/m2a5/coordinator/review.md) accepts the component and its 3,600 audited release samples. Export p99 is 5.201/18.358 ms; host integration still requires bounded offload or incremental coordination. M2a6 law/custody/notices is next after commit. Complete M2a/M2b and all other owners remain pending.
