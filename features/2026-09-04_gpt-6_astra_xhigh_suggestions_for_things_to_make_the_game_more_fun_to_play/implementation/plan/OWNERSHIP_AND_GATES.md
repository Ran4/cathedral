...
| Single-operation resources and actor-duty ownership | M1, integrated with Round | **Proposed** operation kernel: bounded progress, step identity, resource claims and interruption. M6/M7 register mechanical adapters; M8 composes them; M12 retains custody responsibility through failure. |
