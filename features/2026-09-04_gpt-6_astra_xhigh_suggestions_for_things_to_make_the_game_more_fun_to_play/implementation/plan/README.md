Status: Reconciled 2026-09-22. M1–M2 and M3 through native retention retain their earlier acceptance records. Diagnostic sinks, admitted startup services, refusal-only controls, screenshot fixes, and partial M4/M5 foundations are committed; the corrected M6 current-authority slice passed independent review and 36 focused/compatibility tests. M3 actor-source capture, pinned Linux/glibc native directory accounting, shared embedded shelters and the captured sound catalog now have focused verification; other parsed definitions, allocator/platform modes, configuration and complete application accounting remain open. Complete M3 allocation/adoption/save-load and frame acceptance remain unfinished, so M4–M6 are not accepted milestones and M7–M19 have not started. M0 renderer/full-stress evidence remains pending.
...
[M3b1's reviewed handoff](evidence/m3b1/README.md) adds bounded real-file
checkpoint preparation and actual LocalEngine retirement transport. Its final
concurrent workspace passes 2,272 tests, with independent ownership, source and
phase audits. M3b2 must still restore the complete running application; M3c
controls and M3d whole-path acceptance follow.

[M3b2b1's reviewed archive cut](evidence/m3b2b1/README.md) admits archive
capacity before cognition acceptance and retains it through held results,
shared event copies, queued writes and disposal. Its frozen workspace passes
2,292 tests; all 12 new archive witnesses and the compiled preparation-control
bound pass independent review.

[M3b2b2's reviewed native cut](evidence/m3b2b2/README.md) bounds DNS,
recording disposal, child cleanup and realtime close ownership through actual
termination. Its frozen workspace passes 2,300 tests; all eight new lifecycle
witnesses and 46 compiled layouts pass independent audit. Diagnostic sinks,
immutable startup configuration and complete application allocation/adoption
still remain.

The developer subsequently [authorized continued implementation, paused after M1b and then resumed work](EXECUTION_AUTHORITY.md), with a commit after each coherent leg. This overrides the earlier M0 instruction to stop before M1 while retaining the recorded measurement limitations. [M2a1's reviewed component cut](evidence/m2a1/README.md) implements strict replay/operation DTOs, clock/time/manifest components and attached admission. Its workspace run passes 1,881 tests; repeated component measurements preserve byte limits and expose saturated-ledger work that must move or split before host integration. [M2a2’s reviewed handoff](evidence/m2a2/README.md) adds exact private character/inventory state and World reference bindings, with 1,896 workspace tests passing. Six release runs retain 3,600 raw phase samples; populated export/decode p99 of 30.372/37.434 ms require background or incremental execution before host integration. [M2a3’s reviewed handoff](evidence/m2a3/README.md) adds Round/resident/service/production/household/road-party authority, with 1,912 workspace tests passing. Component and ordinary release audits pass; complete-owner composition and host acceptance remain pending. [M2a4’s reviewed handoff](evidence/m2a4/README.md) adds private weather, clock, bell and climate-context authority, with 1,928 workspace tests passing and 3,600 release phase samples audited. [M2a5’s reviewed handoff](evidence/m2a5/README.md) adds private knowledge, pollen and cached journal/ward state, with 1,949 workspace tests passing and 3,600 release phase samples audited. Export p99 of 5.201/18.358 ms preserves the offload requirement. [M2a6’s reviewed handoff](evidence/m2a6/README.md) adds exact existing law/custody/notices and publication-cache authority. Its unchanged owner workspace passes 1,962 tests; five supplemental public boundaries and 3,600 release samples pass independent review. Export p99 is 1.063/4.490 ms. [M2a7’s reviewed handoff](evidence/m2a7/README.md) adds exact marks/catalog/switches and chalk-cache authority. Its frozen workspace passes 1,986 tests; six independent public boundaries and 3,600 release samples pass review. Export p99 is 1.110/4.411 ms. [M2a8’s reviewed handoff](evidence/m2a8/README.md) adds exact existing animals, independent World/Engine navigation bindings, publication state and shared human/dog movement cadence. Its frozen workspace passes 2,004 tests and all 3,600 release phase samples pass independent review. Export p99 is 0.030/0.032 ms. [M2a9’s reviewed handoff](evidence/m2a9/README.md) adds independent ward moods, exact queued/submitted/held Night authority and original Engine Night config. Its unchanged-source workspace retry passes 2,025 tests, and all 3,600 release phase samples pass independent review. Export p99 is 0.048/0.036 ms. Remaining Engine/social/scheduling/pending-work owners and complete M2/M3 adoption remain pending.

[M1a's implementation and verification record](evidence/m1a/README.md) covers retained time debt, exact calendar crossings and the ordinary host/poll boundary. [M1b's reviewed handoff](evidence/m1b/README.md) adds stable command identities, bounded replay admission and receipts for immediate and pending work. [M1c's reviewed handoff](evidence/m1c/README.md) adds runtime generation fences and bounded callback/publication delivery. Its full workspace verification passes 1,840 tests with eight ignored checks; final source hashes and raw evidence are recorded. [M1d’s reviewed handoff](evidence/m1d/README.md) adds the operation/resource/duty kernel. Its full workspace verification passes 1,865 tests with eight ignored; matched CPU measurements meet the ordinary limits and the preliminary fixture ceiling. Save/load remains M2/M3.
