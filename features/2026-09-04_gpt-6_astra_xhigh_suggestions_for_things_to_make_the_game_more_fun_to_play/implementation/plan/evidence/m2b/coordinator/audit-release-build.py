...
assert debug['source_manifest_sha256'] == build['source_manifest_sha256']
assert sha(Path(debug['binary'])) == debug['sha256'] != sha(reference)
write_json(OUT / 'release-build-audit.json', {
    'result': 'passed', 'source_manifest_sha256': build['source_manifest_sha256'],
    'release_binary_sha256': sha(reference), 'debug_binary_sha256': debug['sha256'],
