...
if any(x['name']==label for x in json.loads((Path('features/2026-09-04_gpt-6_astra_xhigh_suggestions_for_things_to_make_the_game_more_fun_to_play/implementation/plan/evidence/m2a11')/'commands.json').read_text())) if (Path('features/2026-09-04_gpt-6_astra_xhigh_suggestions_for_things_to_make_the_game_more_fun_to_play/implementation/plan/evidence/m2a11')/'commands.json').exists() else False: raise SystemExit('duplicate command label')
base=Path('features/2026-09-04_gpt-6_astra_xhigh_suggestions_for_things_to_make_the_game_more_fun_to_play/implementation/plan/evidence/m2a11')
log=Path('/tmp/alibi-m2a11-'+label+'.log')
