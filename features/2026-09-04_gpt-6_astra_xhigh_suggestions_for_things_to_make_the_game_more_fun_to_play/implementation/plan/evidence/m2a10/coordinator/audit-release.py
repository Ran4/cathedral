...
assert build['binary_sha256']['alibi_social_cost'] == binary_hash
...
for directory in ['smoke','performance']:
    ...
    original = Path(f'/tmp/alibi-m2a10-release-{directory}-runner.log')
...
for mode in ['authored','populated']:
    debug = load(e/f'development/{mode}_smoke.json')
