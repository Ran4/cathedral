"""Audit final read-only layout provenance and bounded promotion metadata."""
import hashlib
import json
...
print(json.dumps({
    ...
    "scope": "Fixed DWARF layouts and arithmetic, including promotion metadata; not actual world, host or native heap bounds. Both test ELFs were hashed in place, with no separately preserved copies.",
