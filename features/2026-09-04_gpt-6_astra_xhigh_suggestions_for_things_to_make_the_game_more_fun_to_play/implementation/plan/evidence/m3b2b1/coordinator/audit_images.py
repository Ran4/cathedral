"""Audit final archive layouts and unchanged preparation control allowance."""
import hashlib
import json
...
print(json.dumps({
    ...
    "scope": "Fixed DWARF archive layouts and preparation-control arithmetic; native archive TLS/allocator overhead remains a trusted scoped allowance, not a measured process heap. Complete host/configuration accounting remains pending. Both test ELFs were hashed in place, with no separately preserved copies.",
