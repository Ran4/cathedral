"""Require real archive and predecessor lifetime witnesses in the final run."""
import hashlib
import json
...
print(json.dumps({
    ...
    "archive_witnesses_passed": required,
    "predecessor_boundaries_passed": prior,
    "scope": "Production archive admission, shared payload lifetime and held-result binding; no complete App adoption, startup configuration census, two-world residency or frame acceptance.",
