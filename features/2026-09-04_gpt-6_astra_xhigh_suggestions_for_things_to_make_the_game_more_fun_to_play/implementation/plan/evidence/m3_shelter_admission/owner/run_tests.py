...
PREFIX = ["/usr/bin/nice", "-n", "15", "/home/ran/.cargo/bin/cargo", "test",
          "--locked", "--offline", "-j", "1"]
SUITES = {
    "sim_shelter_admission": ["-p", "cathedral-sim", "--lib", "weather::shelter_admission::tests"],
    "sim_shelter_legacy": ["-p", "cathedral-sim", "--lib", "weather::tests::shelter_json_validates_and_classifies_points"],
    "backend_capture": ["-p", "cathedral-backends", "--lib", "world_data::capture::tests"],
    "sim_lore": ["-p", "cathedral-sim", "--lib", "lore::tests"],
