...
# dependencies = []
# ///
"""Measure M2a2 covered World authority on authored and +2,000 resident worlds.
...
def main():
    ...
    binary = ROOT / "target/release/examples/alibi_backbone_cost"
    before = sources()
    ...
    identity = {
        ...
        "measurement": "Sequential release component API calls; six raw phase timings. "
            "Decode constructs BTree and PlaceRegistry indexes. Candidate validation "
            "validates and transfers existing maps. Expanded/admission charges are "
