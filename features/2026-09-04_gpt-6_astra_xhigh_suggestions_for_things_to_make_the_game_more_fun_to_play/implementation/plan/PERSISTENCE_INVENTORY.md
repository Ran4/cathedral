...
| Remaining `Engine` presentation caches | Last snapshot/chalk/lamp revisions, dogs-published, ready flag | Pending exact owner contracts; future initial host publication must remain separate from M2a4–M2a6 saved climate/journal/ward/law caches and must not replay world creation |
