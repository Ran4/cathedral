# Core Lore of Ombreval

> Compact shared canon for routine LLM context. Load one of the linked subject
> files only when a conversation or writing task needs that detail.
...
The default present year is **F.437**, the 437th year since the first stone of the cathedral.
...
## Other established places

- **Cinder Row** — the glaziers' street, rebuilt after the fire of F.171.
- **The Needle** — the city's narrowest lane; “past the Needle” means beyond saving.
- **The Draper's Reach** — roofed gallery of the cloth halls between Coswald's Yard and the Wickmarket.
- **Gaunt Passage** — blind covered passage beneath old salt-cellars near the Tallage.
...
- **The Combs** — sheep-hills where the Serle rises.
- **Brede** — wool town and head of navigation, three days' pole upstream.
- **Harne** — lord's town four leagues downstream; “to buy peace of Harne” means paying an unavoidable extortionate price.
- **Salorge** — salt-pan town at the river mouth, six days downriver and twelve back.
- **Ostrelle** — distant primatial city, mint, and seat of the Luminary, six weeks away by the **Lantern Road**.

## Institutions and sacred places

- The **Church of the Sole Light**, commonly **the Candor**, teaches *Lux una et indivisa*: one light, undivided. Formal oaths are sworn “by the light that does not lie.”
- The Candor's supreme head is the **Luminary** in Ostrelle. Ombreval's spiritual head is **Praelucent Havise Dorn**, lamp-named Serene.
...
- From inside the Lanthorn, sky seen through the Great Rose contains a cold green-white second sunlike disc. It is invisible through other windows and from everywhere outside.
- It casts a faint second grave-shadow but no heat, healing, voice, or physical trace.
- The appearance belongs to the Great Rose in place; outside the Lanthorn there is always one ordinary sun.
- It moves against the true sun, crosses it daily in the Passing, and aligns annually at the Concurrence.
- The Candor mandates the name **the Emblem**. The street says **the Green Sun**.
- Its origin, nature, and purpose are never resolved. It does not choose, answer, escalate, or perform.

## Naming basics

People use given names with inherited or earned bynames from trade, place, origin, feature, or event. Streets are named for trades, damage, saints, or shape; passages for what they pass beneath; bridges for toll, cargo, or keeping. Secular names are usually practical. Latin belongs mainly to creeds and inscriptions. Waters keep their old names.

## Detailed files to load only when relevant

- World premise, wider geography, and open canon: `lore/core_lore/setting_and_geography.md`
- Historical, present, and game-represented population: `lore/core_lore/population.md`
...
This file is author-facing. Ordinary NPCs know public geography, markets, common religion, and visible facts; they do not automatically know institutional secrets or suppressed experiments.
