...
| Family | Style | Blazon |
|---|---|---|
| **Alder** | grand | Azure, a wavy base argent, a boat Or — the house that kept the boat. |
| **Ashe** | grand | Gules, a saltire argent, a roundel Or in the crossing — the salt house (a *saltire* for salt). |
| **Copp** | grand | Gules, three bezants Or — the money and paper house of the Tallage. |
| **Dorn** | grand | Argent, a lantern radiant Or, on a chief azure three mullets Or — the Praelucent's arms. |
| **Ferrant** | grand | Azure, an estoile Or above a crescent argent — the physician-astronomer. |
| **Marle** | grand | Azure, an estoile Or and a needle argent in bend — she charts the sky in thread. |
| **Rasp** | grand | Grey, an eye argent within a bordure sable — the master of the Custody of the Eye. |
| **Skell** | grand | Vert, a wavy base argent, an eel Or — went ashore to fish and thrived. |
| **Sparr** | grand | Gules, a rose-window Or within a bordure Or — the master glaziers of Idonea's line. |
| **Stott** | grand | Sable, a tower embattled argent beneath a compass — warden of the masons' lodge. |
| **Vell** | grand | Azure, a candle argent enflamed Or — the wax-house of the Wickmarket. |
| **Brant** | minor | Vert, a hunting-horn Or — the criers whose voice runs before the bells. |
| **Crake** | minor | Azure, a wavy base argent, a bird argent between mullets — the Long Departure. |
| **Fitch** | minor | Sable, a spade argent, a mullet in chief argent — the sexton's house of Saint Maren. |
| **Hobbe** | minor | Tenné, a wavy base argent, a cartwheel argent — went to the cart. |
| **Mott** | minor | Sable, a bell argent upon a mount vert — the bellfounder with a foot in the Grey Press. |
| **Pike** | minor | Azure, two keys in saltire argent — the vergers who keep the Lanthorn's doors. |
| **Tarn** | minor | Vert, a wavy base argent, a tun Or — went to barrel and hide. |
| **Kern** | assumed (rough) | Gules, a garb Or — assumed arms of a lettered house with more letters than coin. |
| **Skep** | assumed (rough) | Vert, a skep tenné with bees — canting arms a Skep drew himself; nobody granted them. |
...
See [`../overview.md`](../overview.md) for the full family index.
