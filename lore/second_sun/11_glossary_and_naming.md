# Glossary and Naming Handbook of Ombreval

> Use: reference for writers and generators — canonical vocabulary, naming rules, and the calendar; entries may be injected singly into sidecar NPC context, except daggered entries, which are secrets.
> Canon: 00_canon.md

A dagger (†) marks a secret: inject only into NPCs canon says know it. Entries stop where the street's knowledge stops; the truth-value ledger governs everything deeper.

## I. Glossary

**The anchorhold** — cell in the north wall of the Ilvane Chapel (mortared shut F.290), occupied unbroken since F.211; its squint opens on the lane.

**The Attestation †** — the signed witness required of each new Praelucent since F.289: taken alone to the crossing at the strong hour, made to look, made to sign.
...
**The Concurrence** — the alignment feast, officially the **Feast of the Sole Light**, the fortieth day after Coswaldstide: the Passing centres in the eye and every doubled shadow fuses. Under cloud it simply does not happen.

**The counter-sign †** — the cell's quarterly second pass: a saint's possessive and a terse image, five plain words or fewer ("Belwyn's, unlit"). Turns at the first meeting after each quarter-feast.

**The countergait** — the second sun's motion against the true sun's course.

**Cracked pane †** — the struck-through chalk diamond: pass and counter-sign burned; scatter.
...
**The Draper's Reach** — covered gallery of the cloth halls; the standard ell of Ombreval is an iron rod nailed there.

**The Edict of F.244** — makes calling the Emblem a "sun," a "second sun," or "the green sun" a citable offence: fines, recantation on the Gradine.

**The Emblem** — the mandated term for what shows through the rose: a granted image, no sun at all. ***Una lux, gemina species*** — one light, twofold appearance.

**The eye** — the central round light of the Great Rose.

**The Fabric** — the cathedral works; also the era: F.1 is the first stone, and the present year is F.437.

**Gaunt Passage** — covered passage beneath the salt-cellars of the old Gaunt house, near the Tallage. † Its cellar grate is the Unwalled's door.

**The Gradine** — the cathedral's stepped ceremonial forecourt: processions, recantations, and, at the Shut Door, the crush.
...
***Lux una et indivisa*** — the creed: one light, undivided. From it, the oath of every contract and verdict: ***"by the light that does not lie."***
...
**The Namekeeper †** — keeps the **bede-roll**, the cell's list of its dead, read at every meeting.

**The Needle** — the narrowest pinch in the city, shoulder-wide; "past the Needle" is beyond saving. † Among the children's chalk at its midpoint, sometimes, a glazier's diamond.

**The Orphan** — the Lanthorn bell whose baptismal record burned. Folk distrust an unnamed bell, and stand out from under it.

**The pass †** — the living key to a meeting: the given name of the most recently buried soul the cell's coin paid for, public on the charnel door and the knell. The name is public; the rule is the secret.

**The Passing** — the daily crossing of the two lights in the western rose, late in the **strong hour** (late afternoon, both in the window); the street says **the Kiss**. Crossed rays lay an X of light down the nave.

**The Praelucent** — governor of the Lanthorn and the city's spiritual life; open to women; the incumbent is Havise Dorn, lamp-named Serene.

**Quarter-feast** — one of the four feasts quartering the year: Vhairestide, the Feast of Saint Ambrelle, Coswaldstide, Wet Alms. † The Unwalled count Colm's Night in Vhairestide's place.
...
**The Scold** — the Bellstand's old watch-bell: secular, hired, never christened. Rings the Snuffing curfew and gathers the square for proclamations.

**The Shut Door** — last year's Concurrence scandal, F.436: the Chapter barred the nave doors at the Passing; a crush on the Gradine; a child's arm broken.
...
**The Unwalling †** — the heresy's far hope, and its forbidden verse: ***Lucem non murabis*** — *you shall not wall the light*.

**Wet Alms** — winter feast of bread at the nave door, kept since the Great Rains of F.362; the fourth quarter-feast.

**Wick-priest** — a parish priest: "each parish a wick of the one flame."

**The Wicket †** — the cell's doorkeeper at the grate. A wrong whisper meets weather-talk, and a marked face.

## II. The Rules of Naming

### Citizens

A citizen is a given name and a byname. Bynames come from trade, street, origin, feature, or event; they are earned or inherited, never chosen — a chosen byname marks a fraud. Families of standing fix theirs (Sparr, Copp, Stott, Dorn, Alder; lesser lines: Ashe, Marle, Fitch, Pike, Brant, Vell, Rasp, Ferrant). A woman keeps her byname at marriage. The poor often carry a one-syllable small name and nothing after.

Given names — men: Aubin, Colm, Corin, Dunstan, Grigor, Hamel, Jos, Noll, Segwin; also Ansel, Bertran, Ewart, Gile, Renn, Tobin. Women: Aldith, Betriss, Ede, Havise, Idonea, Jonet, Lise, Osanne; also Averil, Clemence, Petronel, Rohese, Sibbe. Small names: Pin, Ib, Cobb, Sef; also Dob, Mote, Nan, Tib. New family names run short and consonant-heavy: Crake, Hobbe, Skell, Tarn.

1. *Gile Salter* — trade.
2. *Petronel Roper* — trade; the ropewalk on the Cut.
...
10. *Bertran Scaffold* — event; earned on the Fabric works.
11. *Wyn Alder* — fixed family.
12. *Sibbe Crake* — fixed family, lesser line.
...
A church bell is christened at casting like a baptism: the guild that paid stands godparent; the name is two parts, a saint and a voice-word; a motto is cast into the waist in the bell's own first person; the mould is broken after. A recast bell keeps its name. Voice-words: -mouth, -voice, -throat, -tongue, -call, -blow, -cry, -tone. Secular bells are hired, not christened.

1. *Great Ambrelle, called Gravemouth* — bourdon; *SOLI LUCI CANO*.
2. *Coswald Ironthroat* — the alarm.
3. *Vhairé Farcall* — fog and flood; *SICCA TRANSIVI*, "dry I crossed."
4. *Perrin Evenblow* — the hours.
5. *Gaudry Truetongue* — the court; *PONDUS IUSTUM*, "just weight."
6. *Maren Smallvoice* — the passing-bell of Saint Maren's.
7. *The Orphan* — counter-example: name burned, trust with it.
8. *The Scold* — counter-example: secular, so never christened.
9. *Ambrelle Clearcall* — a mintable chapel bell.
10. *Belwyn Stillcry* — a mintable pattern for a bell rung seldom.

### Offices and feasts

The Candor names its offices inside one metaphor — light and its keeping, fabric and its keeping. Latin belongs to creed and motto; office takes plain speech: Luminary; Praelucent ("who shines before"); Provost of the Fabric; Provost of the Rite; Provost-Custodian; Canon of the Rose; wick-priest; verger; sexton; Taper (a novice). The Custody does not christen its clerks; they are grey, and that is name enough. A Praelucent's lamp-name is a virtue a flame can have — Vigil, Serene, Taper-of-Dawn; mintable: Constant, Clear-Burning, Even-Flame, Late-Kindled, Sheltered — though the street uses the family name anyway.

Feasts: formally *Feast of Saint N—*; the street clips it to *-stide*. Feasts of act are named for the act done; a struck feast leaves a nameless day. Examples: Feast of Saint Ambrelle (street: Ambrellestide); Coswaldstide; Vhairestide; Marenstide; Perrinstide; Gaudry's Audit (street: Weighday); Belwyn's Dark; the Feast of the Sole Light (street: the Concurrence); Wet Alms; Colm's Night (unofficial); Bellday; and the nameless day that was Ilvanestide until F.290.

## III. The Calendar of Ombreval

Years count in the Fabric era; dates are located by feast, chronicle-style: "the third day after Coswaldstide, F.436." The year is quartered by the quarter-feasts, and the year-number turns at Vhairestide — the first stone was laid on Saint Vhairé's ground. The week runs seven days: **Bellday** first, **Highmarket** third (the Wickmarket, Coswald's Yard), **Lowmarket** sixth (the Tallage, Maren's Green; salt is weighed there); the rest are counted ("second after Bellday"). The day runs by the seven hours, rung on Perrin Evenblow; curfew is the Scold's.
...
- **Wet Alms** (winter; fourth quarter-feast) — bread at the nave door.
- **Belwyn's Dark** (midwinter) — the Custody's patronal day; the one office of the year sung unlit.
- **Gaudry's Audit** (late winter) — Weighday: the Tallage stone and Gaudry weights proved, ledgers closed and sworn "by the light that does not lie."

† And beneath the calendar, another clock: each pauper's burial the cell pays resets the pass, so that to nineteen people in Ombreval the name-knell of Maren Smallvoice is the sound of a key turning.
