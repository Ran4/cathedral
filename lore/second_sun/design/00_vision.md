...
- **Items within 4 m.** Pilgrim badges, green-dipped candles, forged and genuine Sparr pages — the contraband economy uses the existing offer/accept verb unchanged. A Sparr page changing hands at the Tally Bridge is the item system plus context, nothing more.
